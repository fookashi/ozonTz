...
type UserRepo interface {
	...
	GetManyByIds(ctx context.Context, ids []uuid.UUID) ([]entity.User, error)
...
type CommentRepo interface {
	...
	GetReplies(ctx context.Context, parentId uuid.UUID, limit, offset int) ([]*entity.Comment, error)
}
